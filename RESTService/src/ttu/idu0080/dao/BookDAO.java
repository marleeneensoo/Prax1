...
public class BookDAO extends DAO{
	...
	public Book saveBook(Book book){
		...
		try {
			...
			preparedStmt.setString(1, Converter.toUTF8(book.getTitle()));
		    preparedStmt.setString(2, Converter.toUTF8(book.getAuthor()));
		    preparedStmt.setString(3, Converter.toUTF8(book.getGenre()));
